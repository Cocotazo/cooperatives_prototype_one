...
class RoutesProviders{
  ...
  Future<List<Point>> getPoints() async {
    _points = new List();
    final response = await http.get('https://maps.googleapis.com/maps/api/directions/json?origin=${_initialCoordinate.latitude}, ${_initialCoordinate.longitude}&destination=${_finalCoordinates.latitude}, ${_finalCoordinates.longitude}&key=AIzaSyA4G1xQKDB66uw6w55ambEag1L_0v0o134');
